// supabase/functions/create-swish-checkout/index.ts
...
serve(async (req) => {
  ...
  // ✅ Block unknown origins (important in prod)
  ...
  try {
    ...
    const pendingUrl = userId
      ...
      : `${checkoutBase}/order-confirmation?order=${encodeURIComponent(order_number)}&token=${encodeURIComponent(
          guestToken!,
        )}`;
